#This script uses the data created by query_database_multiple_stations.R
#and applies the canadian fire weather index. 

#NOTE: query_database_multiple_stations.R worked correctly in 2021, but 
...
#write it to csv
write.csv(fwi_out_test, "fwi_output/test.csv", row.names = FALSE)
...
output_folder <- "/home/pflattery/fire/fwi_output/"
